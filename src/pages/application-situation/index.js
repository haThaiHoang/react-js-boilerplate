...
import { Page, Container, Button, Select, Input } from '@/components'
import languageEN from '@/languages/application-situation/en.json'
import languageJP from '@/languages/application-situation/jp.json'
